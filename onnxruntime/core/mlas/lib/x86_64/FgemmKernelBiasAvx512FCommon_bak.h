...
--*/
        # VectorOffset: 0 or 64(next block in K dim)
        # BroadcastOffset: 0, 4, 8, 12 # element_size
        # PrefetchOffset: 4 blocks * 64(each block)
        # r12: 64CountK -- next block column
        # rcx: CountK

        # produce: 12 x 2(x16) results based on one dim of 64CountK
        # outter loop: loop through whole CountK (step 4), and advance B(rsi), A(rdi, rbx, r13, r14) accordingly
        .macro ComputeBlockAvx512FBy2 RowCount, VectorOffset, BroadcastOffset, PrefetchOffset

.ifnb \PrefetchOffset\()
        prefetcht0 [rsi+\VectorOffset\()+\PrefetchOffset\()]            # prefetch next 4
        prefetcht0 [rsi+r12+\VectorOffset\()+\PrefetchOffset\()]        # prefetch next 4 in next block column
.endif
.if \RowCount\() == 1
...
.else
        vmovapf zmm0,ZMMWORD PTR [rsi+\VectorOffset\()]                 # zmm0 = B first row, first block column
        vmovapf zmm1,ZMMWORD PTR [rsi+r12+\VectorOffset\()]             # zmm1 = B first row, second block column
        EmitIfCountGE \RowCount\(), 1, "vbroadcastsf zmm3,[rdi+\BroadcastOffset\()]"            # zmm3 = A first row, first element x 16
        EmitIfCountGE \RowCount\(), 1, "vfmadd231pf zmm4,zmm3,zmm0"                             # zmm4 = accum on Broadcast A x B block 
        EmitIfCountGE \RowCount\(), 1, "vfmadd231pf zmm5,zmm3,zmm1"                             # zmm5 = accum on Broadcast A x B 2nd block
        EmitIfCountGE \RowCount\(), 2, "vbroadcastsf zmm3,[rdi+r10+\BroadcastOffset\()]"        # zmm3 = A 2nd row, first element x 16
        ...
        EmitIfCountGE \RowCount\(), 4, "vbroadcastsf zmm3,[rbx+\BroadcastOffset\()]"            # zmm3 = A 3rd row, first element x 16
...
# set rbx, r13 r14 as the every 3rd row of A
# r10 is lda
.if \RowCount\() > 3
        lea     rbx,[r10*2+r10]
.if \RowCount\() == 12
...
.endif
        # calc 4 elements each time, advance rdi, rbx, r13 r14 by 4 after each call
        ComputeBlockLoop \ComputeBlock\(), \RowCount\(), \RowCount\() > 3
# set rbx, r13 r14 as the every 3rd row of C
# rax is ldc
.if \RowCount\() > 3
        lea     rbx,[rax*2+rax]
.if \RowCount\() == 12
...
.LProcessNextColumnLoop2xN\@:
        ...
        EmitIfCountGE \RowCount\(), 1, "vfmadd213pf zmm4,zmm31,ZMMWORD PTR [r16]"       # orig: [rdx] C
        EmitIfCountGE \RowCount\(), 2, "vfmadd213pf zmm6,zmm31,ZMMWORD PTR [r16]"       # orig: [rdx+rax] C + ldc
        EmitIfCountGE \RowCount\(), 3, "vfmadd213pf zmm8,zmm31,ZMMWORD PTR [r16]"       # orig: [rdx+rax*2] C + 2ldc
        EmitIfCountGE \RowCount\(), 4, "vfmadd213pf zmm10,zmm31,ZMMWORD PTR [r16]"      # orig: [rbx] C + 3ldc
        EmitIfCountGE \RowCount\(), 5, "vfmadd213pf zmm12,zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 6, "vfmadd213pf zmm14,zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm16,zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm18,zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm20,zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm22,zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm24,zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm26,zmm31,ZMMWORD PTR [r16]"
        add     r16,.LFgemmElementSize
        jmp     .LStore2xNBlock\@
...
.LOutput1xNBlockWithMask\@:
        ...
        EmitIfCountGE \RowCount\(), 1, "vfmadd213pf zmm5{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 2, "vfmadd213pf zmm7{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 3, "vfmadd213pf zmm9{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 4, "vfmadd213pf zmm11{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 5, "vfmadd213pf zmm13{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 6, "vfmadd213pf zmm15{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm17{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm19{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm21{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm23{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm25{k1},zmm31,ZMMWORD PTR [r16]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm27{k1},zmm31,ZMMWORD PTR [r16]"
        add     r16,.LFgemmElementSize
...
--*/
        ...
        mov     r16,.LFgemmKernelFrame_Bias[rsp] # rbp + 40
