...
.else
        ...
        EmitIfCountGE \RowCount\(), 14, "vbroadcastsf zmm3,[r8+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 14, "vfmadd231pf zmm28,zmm3,zmm0"
        EmitIfCountGE \RowCount\(), 14, "vfmadd231pf zmm29,zmm3,zmm1"
        EmitIfCountGE \RowCount\(), 14, "vbroadcastsf zmm3,[r8+r10+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 14, "vfmadd231pf zmm30,zmm3,zmm0"
        EmitIfCountGE \RowCount\(), 14, "vfmadd231pf zmm31,zmm3,zmm1"
.endif
...
.endif
        ...
        EmitIfCountGE \RowCount\(), 14, "vfmadd231pf_bcst zmm29,zmm0,[r8+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 14, "vfmadd231pf_bcst zmm31,zmm0,[r8+r10+\BroadcastOffset\()]"

        .endm

// moved from FgemmKernelCommon.h
...
.if \RowCount\() == 14
        lea     r8,[r14+rbx]                # compute matrix A plus 12 rows
.endif
.endif
...
.if \RowCount\() == 14
        lea     r8,[r14+rbx]                # compute matrix C plus 12 rows
.endif
.endif
