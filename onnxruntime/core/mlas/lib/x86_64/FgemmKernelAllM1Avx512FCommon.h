...
--*/
        ...
        .macro ComputeBlockLoopM1 ComputeBlock, RowCount, AdvanceMatrixAPlusRows

        mov     rbp,rcx                     # reload CountK
        sub     rbp,4
        jb      .LProcessRemainingBlocksM1\@

.LComputeBlockBy4LoopM1\@:
...
.endif
        sub     rbp,4
        jae     .LComputeBlockBy4LoopM1\@

.LProcessRemainingBlocksM1\@:
        add     rbp,4                       # correct for over-subtract above
        jz      .LOutputBlockM1\@

.LComputeBlockBy1LoopM1\@:
...
--*/
        ...
        .macro ComputeBlockAvx512FBy2M1 RowCount, VectorOffset, BroadcastOffset, PrefetchOffset
...
.else
        ...
        EmitIfCountGE \RowCount\(), 7, "vbroadcastsf zmm3,[r13+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 7, "vfmadd231pf zmm16,zmm3,zmm0"
        EmitIfCountGE \RowCount\(), 7, "vfmadd231pf zmm17,zmm3,zmm1"
        EmitIfCountGE \RowCount\(), 8, "vbroadcastsf zmm3,[r13+r10+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 8, "vfmadd231pf zmm18,zmm3,zmm0"
        EmitIfCountGE \RowCount\(), 8, "vfmadd231pf zmm19,zmm3,zmm1"
        EmitIfCountGE \RowCount\(), 9, "vbroadcastsf zmm3,[r13+r10*2+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 9, "vfmadd231pf zmm20,zmm3,zmm0"
        EmitIfCountGE \RowCount\(), 9, "vfmadd231pf zmm21,zmm3,zmm1"
        EmitIfCountGE \RowCount\(), 10, "vbroadcastsf zmm3,[r14+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 10, "vfmadd231pf zmm22,zmm3,zmm0"
        EmitIfCountGE \RowCount\(), 10, "vfmadd231pf zmm23,zmm3,zmm1"
        EmitIfCountGE \RowCount\(), 11, "vbroadcastsf zmm3,[r14+r10+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 11, "vfmadd231pf zmm24,zmm3,zmm0"
        EmitIfCountGE \RowCount\(), 11, "vfmadd231pf zmm25,zmm3,zmm1"
...
--*/
        ...
        .macro ComputeBlockAvx512FBy1M1 RowCount, VectorOffset, BroadcastOffset, PrefetchOffset
...
.endif
        ...
        EmitIfCountGE \RowCount\(), 7, "vfmadd231pf_bcst zmm17,zmm0,[r13+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 8, "vfmadd231pf_bcst zmm19,zmm0,[r13+r10+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 9, "vfmadd231pf_bcst zmm21,zmm0,[r13+r10*2+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 10, "vfmadd231pf_bcst zmm23,zmm0,[r14+\BroadcastOffset\()]"
        EmitIfCountGE \RowCount\(), 11, "vfmadd231pf_bcst zmm25,zmm0,[r14+r10+\BroadcastOffset\()]"
...
--*/
        ...
        .macro ComputeBlockAvx512FLoopM1 ComputeBlock, RowCount
...
.endif
        ComputeBlockLoopM1 \ComputeBlock\(), \RowCount\(), \RowCount\() > 3
.if \RowCount\() > 3
        lea     rbx,[rax*2+rax]
//.if \RowCount\() == 12
.if \RowCount\() > 6
...
--*/
        ...
        .macro ProcessCountM1 RowCount

        cmp     r9,.LFgemmZmmElementCount
        jbe     .LProcessRemainingCountNM1\@

.LProcessNextColumnLoop2xNM1\@:
        EmitIfCountGE \RowCount\(), 7, "vmovapf zmm16,zmm4"
                                            # clear upper block accumulators
        EmitIfCountGE \RowCount\(), 7, "vmovapf zmm17,zmm5"
        EmitIfCountGE \RowCount\(), 8, "vmovapf zmm18,zmm4"
        EmitIfCountGE \RowCount\(), 8, "vmovapf zmm19,zmm5"
        EmitIfCountGE \RowCount\(), 9, "vmovapf zmm20,zmm4"
        EmitIfCountGE \RowCount\(), 9, "vmovapf zmm21,zmm5"
        EmitIfCountGE \RowCount\(), 10, "vmovapf zmm22,zmm4"
        EmitIfCountGE \RowCount\(), 10, "vmovapf zmm23,zmm5"
        EmitIfCountGE \RowCount\(), 11, "vmovapf zmm24,zmm4"
        EmitIfCountGE \RowCount\(), 11, "vmovapf zmm25,zmm5"
        EmitIfCountGE \RowCount\(), 12, "vmovapf zmm26,zmm4"
        EmitIfCountGE \RowCount\(), 12, "vmovapf zmm27,zmm5"
        ComputeBlockAvx512FLoopM1 ComputeBlockAvx512FBy2M1, \RowCount\()
        add     rsi,r12                     # advance matrix B by 64*CountK bytes
        test    r15b,r15b                   # ZeroMode?
        jnz     .LMultiplyAlpha2xNBlockM1\@
        ...
        EmitIfCountGE \RowCount\(), 7, "vfmadd213pf zmm16,zmm31,ZMMWORD PTR [r13]"
        EmitIfCountGE \RowCount\(), 8, "vfmadd213pf zmm18,zmm31,ZMMWORD PTR [r13+rax]"
        EmitIfCountGE \RowCount\(), 9, "vfmadd213pf zmm20,zmm31,ZMMWORD PTR [r13+rax*2]"
        EmitIfCountGE \RowCount\(), 10, "vfmadd213pf zmm22,zmm31,ZMMWORD PTR [r14]"
        EmitIfCountGE \RowCount\(), 11, "vfmadd213pf zmm24,zmm31,ZMMWORD PTR [r14+rax]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm26,zmm31,ZMMWORD PTR [r14+rax*2]"
        jmp     .LStore2xNBlockM1\@

.LMultiplyAlpha2xNBlockM1\@:
        ...
        EmitIfCountGE \RowCount\(), 7, "vmulpf zmm16,zmm16,zmm31"
        EmitIfCountGE \RowCount\(), 8, "vmulpf zmm18,zmm18,zmm31"
        EmitIfCountGE \RowCount\(), 9, "vmulpf zmm20,zmm20,zmm31"
        EmitIfCountGE \RowCount\(), 10, "vmulpf zmm22,zmm22,zmm31"
        EmitIfCountGE \RowCount\(), 11, "vmulpf zmm24,zmm24,zmm31"
...
.LStore2xNBlockM1\@:
        ...
        EmitIfCountGE \RowCount\(), 7, "vmovupf ZMMWORD PTR [r13],zmm16"
        EmitIfCountGE \RowCount\(), 8, "vmovupf ZMMWORD PTR [r13+rax],zmm18"
        EmitIfCountGE \RowCount\(), 9, "vmovupf ZMMWORD PTR [r13+rax*2],zmm20"
        EmitIfCountGE \RowCount\(), 10, "vmovupf ZMMWORD PTR [r14],zmm22"
        EmitIfCountGE \RowCount\(), 11, "vmovupf ZMMWORD PTR [r14+rax],zmm24"
...
.LOutput1xNBlockWithMaskM1\@:
        test    r15b,r15b                   # ZeroMode?
        jnz     .LMultiplyAlpha1xNBlockWithMaskM1\@
        ...
        EmitIfCountGE \RowCount\(), 7, "vfmadd213pf zmm17{k1},zmm31,ZMMWORD PTR [r13]"
        EmitIfCountGE \RowCount\(), 8, "vfmadd213pf zmm19{k1},zmm31,ZMMWORD PTR [r13+rax]"
        EmitIfCountGE \RowCount\(), 9, "vfmadd213pf zmm21{k1},zmm31,ZMMWORD PTR [r13+rax*2]"
        EmitIfCountGE \RowCount\(), 10, "vfmadd213pf zmm23{k1},zmm31,ZMMWORD PTR [r14]"
        EmitIfCountGE \RowCount\(), 11, "vfmadd213pf zmm25{k1},zmm31,ZMMWORD PTR [r14+rax]"
        EmitIfCountGE \RowCount\(), 12, "vfmadd213pf zmm27{k1},zmm31,ZMMWORD PTR [r14+rax*2]"
        jmp     .LStore1xNBlockWithMaskM1\@

.LMultiplyAlpha1xNBlockWithMaskM1\@:
        ...
        EmitIfCountGE \RowCount\(), 7, "vmulpf zmm17,zmm17,zmm31"
        EmitIfCountGE \RowCount\(), 8, "vmulpf zmm19,zmm19,zmm31"
        EmitIfCountGE \RowCount\(), 9, "vmulpf zmm21,zmm21,zmm31"
        EmitIfCountGE \RowCount\(), 10, "vmulpf zmm23,zmm23,zmm31"
        EmitIfCountGE \RowCount\(), 11, "vmulpf zmm25,zmm25,zmm31"
        EmitIfCountGE \RowCount\(), 12, "vmulpf zmm27,zmm27,zmm31"

.LStore1xNBlockWithMaskM1\@:
        ...
        EmitIfCountGE \RowCount\(), 7, "vmovupf ZMMWORD PTR [r13]{k1},zmm17"
        EmitIfCountGE \RowCount\(), 8, "vmovupf ZMMWORD PTR [r13+rax]{k1},zmm19"
        EmitIfCountGE \RowCount\(), 9, "vmovupf ZMMWORD PTR [r13+rax*2]{k1},zmm21"
        EmitIfCountGE \RowCount\(), 10, "vmovupf ZMMWORD PTR [r14]{k1},zmm23"
        EmitIfCountGE \RowCount\(), 11, "vmovupf ZMMWORD PTR [r14+rax]{k1},zmm25"
        EmitIfCountGE \RowCount\(), 12, "vmovupf ZMMWORD PTR [r14+rax*2]{k1},zmm27"
        add     rdx,64                      # advance matrix C by ZMMWORD
        mov     rdi,r11                     # reload matrix A
        vzeroall
        cmp     r9,.LFgemmZmmElementCount
        ja      .LProcessNextColumnLoop2xNM1\@
        test    r9,r9
        jz      .LExitKernelM1

.LProcessRemainingCountNM1\@:
        EmitIfCountGE \RowCount\(), 7, "vmovapf zmm17,zmm5"
                                            # clear upper block accumulators
        EmitIfCountGE \RowCount\(), 8, "vmovapf zmm19,zmm5"
        EmitIfCountGE \RowCount\(), 9, "vmovapf zmm21,zmm5"
        ...
        EmitIfCountGE \RowCount\(), 11, "vmovapf zmm25,zmm5"
        EmitIfCountGE \RowCount\(), 12, "vmovapf zmm27,zmm5"
        ComputeBlockAvx512FLoopM1 ComputeBlockAvx512FBy1M1, \RowCount\()
        jmp     .LOutput1xNBlockM1\@
...
--*/
        ...
        .macro FgemmKernelAllM1Avx512FFunction FunctionName
...
//
        ...
        cmp     r8,12
        jb      .LProcessCountMLessThan12M1
        mov     r8d,12                      # return 12 rows handled
        ProcessCountM1 12

.LProcessCountMLessThan12M1:
        cmp     r8,11
        je      .LProcessCountM11M1
        cmp     r8,9
        ja      .LProcessCountM10M1
        je      .LProcessCountM9M1
        cmp     r8,7
        ja      .LProcessCountM8M1
        je      .LProcessCountM7M1
        cmp     r8,5
        ja      .LProcessCountM6M1
        je      .LProcessCountM5M1
        cmp     r8,3
        ja      .LProcessCountM4M1
        je      .LProcessCountM3M1
        cmp     r8,1
        je      .LProcessCountM1M1
